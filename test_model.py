...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str,
                        default='/media/public/Disk/Sunchen/sc/yolov5/models/yolov5-shufflenetv2_eca.yaml',
                        help='model.yaml path')
    parser.add_argument('--hyp', type=str, default='/media/public/Disk/Sunchen/sc/yolov5/data/hyps/hyp.scratch-low.yaml',
